...
/**
 * Classe copie/colle du plugin maven-assembly-plugin.
 *
 * ATTENTION : NE PAS MODIFER CETTE CLASSE
 *
 * @noinspection ALL
 * @see org.apache.maven.plugin.assembly.mojos.AbstractAssemblyMojo.
 */
public abstract class CopyPastedClass
    ...
    /**
     * This is the artifact classifier to be used for the resultant assembly artifact. Normally, you would use
     * the assembly-id instead of specifying this here.
     *
     ...
     * <code>&lt;directory&gt;</code> specifications in the assembly descriptor.  This is an optional
     * parameter
     *
     * @parameter
     */
    ...
    /**
     * Sets the TarArchiver behavior on file paths with more than 100 characters length. Valid values are:
     * "warn" (default), "fail", "truncate", "gnu", or "omit".
     *
    ...
    /**
     * This is a set of instructions to the archive builder, especially for building .jar files. It enables
     * you to specify a Manifest file for the jar, in addition to other options.
     *
     * @parameter
     */
        ...
        for (Iterator assemblyIterator = assemblies.iterator(); assemblyIterator.hasNext();) {
            ...
            try {
                ...
                throw new MojoFailureException(assembly,
                                               ...
                                               "Assembly: "
                                               + assembly.getId() + " is not configured correctly: " + e
                                                     .getMessage());
            }
        }
    }
